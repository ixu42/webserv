...
#    Updated: 2024/07/04 00:53:28 by vshchuki         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# Source files
SRCS = $(addsuffix .cpp, main Socket Server Request Response Utility ServerException ServersManager Config ConfigValidator CGIHandler)
